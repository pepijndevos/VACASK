...
public:
    ...
    enum class Build { Models, Instances };
...
protected:
    bool buildBlock(Circuit& circuit, RpnEvaluator& evaluator, InstantiationData& idata, const PTBlock& block, Build what=Build::Instances, Status& s=Status::ignore);
