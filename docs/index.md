...
2. Circuit Description and Elaboration
   ...
   3. [Models](input-cir-model.md)
   4. [Instances](input-cir-instance.md)
   5. [Subcircuits](input-cir-subcircuit.md)
   6. [Parallel Devices (`$mfactor`)](input-cir-multiplier.md)
   7. [Parametrization](input-cir-param.md)
